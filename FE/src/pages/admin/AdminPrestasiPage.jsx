    ...
    <div className="w-full px-4 py-5 sm:px-6 sm:py-6 lg:px-8 lg:py-8 animate__animated animate__fadeInUp animate__faster">
      ...
      <div className="flex flex-col gap-3 mb-6 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 bg-primary hover:bg-red-800 text-white px-4 py-3 rounded-xl font-bold text-sm shadow-lg shadow-red-900/25 transition min-h-[44px] w-full sm:w-auto">
      ...
      <div className="bg-white p-2 sm:p-3 rounded-2xl border border-gray-100 shadow-sm flex flex-col gap-2 sm:gap-3 lg:flex-row lg:items-center lg:justify-between mb-5 sm:mb-6">
        {/* ✅ Tabs — wrap di mobile agar tidak overflow */}
        <div className="flex items-center gap-1 flex-wrap">
          {TABS.map((tab) => (
            <button
              ...
              className={`px-3 py-2 rounded-xl text-xs font-bold whitespace-nowrap transition-all min-h-[36px] ${
                activeTab === tab
