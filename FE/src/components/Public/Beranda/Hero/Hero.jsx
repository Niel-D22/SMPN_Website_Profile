...
const Hero = () => {
  ...
  return (
    <section className="relative w-full">
      ...
      {/* CARD */}
      <div className="bg-white md:flex-col  rounded-[24px] sm:rounded-[30px] shadow-2xl p-5 sm:p-8 md:p-12 flex flex-col sm:flex-row items-center gap-6 sm:gap-8 border border-gray-100">
        {/* FOTO */}
        ...
        {/* TEKS */}
        <div className="flex-grow text-center md:text-center sm:flex-col sm:text-left w-full sm:w-auto">
          ...
          <p className="text-gray-600 leading-relaxed text-xs sm:text-sm md:text-base max-w-2xl">
            Selamat datang di website resmi SMP Negeri 3 Manado. Kami berkomitmen untuk menciptakan
            lingkungan belajar yang inovatif, berkarakter, dan mencetak generasi unggul bagi masa
            depan bangsa.
          </p>
        </div>

        {/* STAT */}
        <div className="w-full sm:w-auto md:border-hidden sm:border-l-2 border-gray-200 sm:pl-8 shrink-0 border-t-2 sm:border-t-0 pt-4 sm:pt-0">
