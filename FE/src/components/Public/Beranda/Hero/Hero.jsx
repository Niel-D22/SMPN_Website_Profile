...
const Hero = () => {
  return (
    <section className="relative w-full">
      ...
      <div
        className="max-w-screen-xl mx-auto px-4 -mt-20 md:-mt-32 relative z-10"
        data-aos="fade-up"
        data-aos-delay="700">
        <div className="bg-white rounded-[30px] shadow-2xl p-4 md:p-12 flex flex-col md:flex-row items-center gap-4 md:gap-8 border border-gray-100">
          ...
          <div className="max-w-screen-xl mx-auto ">
            <div className="w-full p-4 md:p-6 flex flex-col md:border-l-2 border-gray-300 mt-4 md:mt-6">
              ...
              <div className="flex flex-col md:flex-row justify-center items-center gap-2 md:gap-10">
                <div className="flex flex-row md:flex-row gap-2 md:gap-10 w-full justify-center items-center">
                  ...
                  {/* divider: tampil hanya di md ke atas */}
                  <div className="hidden md:block h-4 w-[1px] md:h-10 md:w-[1px] bg-gray-300 md:self-center"></div>
                  <div className="text-center flex-1">
